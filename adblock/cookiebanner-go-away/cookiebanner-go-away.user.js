...
// @downloadURL  https://raw.githubusercontent.com/DerBunman/userscripts/main/adblock/cookiebanner-go-away/cookiebanner-go-away.user.js
// @updateURL    https://raw.githubusercontent.com/DerBunman/userscripts/main/adblock/cookiebanner-go-away/cookiebanner-go-away.user.js
// @homepage     https://raw.githubusercontent.com/DerBunman/userscripts/main/adblock/cookiebanner-go-away
// @version      0.3.4-1
// @author       Original Author Dominik Deobald, some changes by DerBunman 
// @match        http://*/*
// @match        https://*/*
// @grant        none
...
(function() {
    ...
    var config = {
        selectors: {
		 ...
		 // https://retest.de/
                {hostname: /./, action: "click", target: "#hs-eu-confirmation-button"}
            ],
            rulesdelay: [
